...
#' @description This function releases the target object predicted_data as a parquet file
...
release_ndvi_predictions <- function(predicted_data,
  ...
  write_parquet(x = predicted_data,
