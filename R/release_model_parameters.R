...
#' @description This function releases the target object model_prediction as a parquet file
...
release_model_parameters <- function(model_prediction,
  ...
  # Create arrow datasets
    ...
    write_parquet(x = model_prediction,
                  sink = file.path(temp_directory_output,
                                   paste("model_parameters",
                                         ".gz.parquet", sep = "")),
                  compression = "gzip",
