...
testing_window=c("2014-06-01","2022-07-01")
...
list(
  ...
  tar_target(envdata,
             tidy_static_data(
               ...
               region=c(xmin = 19.49103, xmax = 19.54062, ymin = -33.97324, ymax = -33.92123), #jonaskop xmin: 19.49103 ymin: -33.97324 xmax: 19.54062 ymax: -33.92123
               #region=c(xmin = 18.3, xmax = 19.3, ymin = -34.3, ymax = -33.3), #core
               #region=c(xmin = 0, xmax = 30, ymin = -35, ymax = -20), #cfr
